...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const thirdActionRow = new ActionRowBuilder().addComponents(hourInput);
        const fourthActionRow = new ActionRowBuilder().addComponents(mainInput);
        const fifthActionRow = new ActionRowBuilder().addComponents(bodyInput);
